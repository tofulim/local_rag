...
class VectorDB:
    ...
    def __init__(self, dim: int):
        # 현재 지정한 embedding model의 dim을 사용
        self.dim = dim
        self.index = faiss.IndexFlatL2(self.dim)

        print(f"Init VectorDB with dim: {self.dim}")
...
if __name__ == "__main__":
    ...
    vdb = VectorDB(vectorizor.embedding_dim)
